...
import Exception1.TokenException;
...
public class JwtUtil {
    ...
    private String secretKey = "1TjXchw5FloESb63Kc+DFhTARvpWL4jUGCwfGWxuG5SIf/1y/LgJxHnMqaF6A/ij";  // Bạn nên lưu secret key ở nơi an toàn, ví dụ như trong file cấu hình
    ...
    public String generateToken(String username, Collection<? extends GrantedAuthority> authorities) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 1))  // Token có hiệu lực trong 1p
